...
```{r bostonsummary, fig.cap="Summary of Boston suburbs",fig.width=5,fig.asp=1, fig.align='center', echo=FALSE}
...
```
I would choose 5 clusters, because sum of distances from centroids is reducing fast until that.
...
Well, it's ´time()' and time to stop!